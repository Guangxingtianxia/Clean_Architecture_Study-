 ...
 * UserComponent生成的依赖，被注入到UserListFragment,
 * UserDetailsFragment。UserListFragment,
 * UserDetailsFragment调用UserComponent实例的inject方法。
 * 可以注入到UserListFragment,UserDetailsFragment的依赖是GetUserListUseCase,
