...
public class UserListFragment extends BaseFragment implements UserListView
{
    ...
    // 使用Inject注解，声明了一个成员@Inject UserListPresenter userListPresenter;
    // 然后，调用UserComponent实例的方法inject，
    // 就可以将依赖userListPresenter注入到UserListFragment实例中。
    ...
    /**
     * UserListFragment跟宿主Activity的通信，
     * 通过UserListFragment声明的接口UserListListener来实现
     *
     * @param activity
     */
    @Override
