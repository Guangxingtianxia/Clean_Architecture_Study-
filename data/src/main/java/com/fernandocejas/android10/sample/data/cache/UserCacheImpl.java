...
public class UserCacheImpl implements UserCache
{
     ...
     */
    @Inject
    UserCacheImpl(Context context, Serializer serializer, FileManager fileManager, ThreadExecutor
            executor)
    {
    ...
    public Observable<UserEntity> get(final int userId)
    {
        return Observable.create(emitter->
        {
            ...
            final String fileContent = UserCacheImpl.this.fileManager.readFileContent
                    (userEntityFile);
            final UserEntity userEntity = UserCacheImpl.this.serializer.deserialize(fileContent,
                    UserEntity.class);
